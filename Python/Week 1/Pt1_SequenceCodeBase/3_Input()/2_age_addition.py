...
# either put int before the inputs or after when you do the total, not both.

print(total)
print("the answer to number1 + number2 is", total)
print(f"The answer to {num1} + {num2} is {total}")
...
# float is used when you want decimal number.