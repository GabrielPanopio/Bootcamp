...
#Modify your program to use variables instead of hard coded values 1

# format print output
"""
myNum1 = 2
myNum2 = 4
print (f"The answer to {myNum1} x {myNum2} = {myNum1 * myNum2}")
print ("The answer to" + str(myNum1) + " x " + "=", myNum1 * myNum2)
"""

if you are going to use variables, place f before the brackets.
eg. print(f"xxxxxxxxxxx")